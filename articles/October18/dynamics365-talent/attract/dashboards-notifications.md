...
Attract の新しいダッシュボードには、さまざまな Attract ロールの関連データが表示されます。 これは、注意が必要な項目、傾向、関連情報についてのガイダンスをユーザーに提供します。 インテリジェントな検索は、Attract の構造化されたデータと構造化されていないデータを検索して関連レコードをすばやく見つける機能で、ダッシュボードを補助します。 通知は、アプリケーション内および今日の電子メールで受け取った既存の通知内でのアクションの呼び出しを提供します。
